...
public class JDBCExample {
	...
	public static void main(String[] args) {
		...
		// JDBC : Java에서 DB에 연결(접근)할 수 있게 java - Programming API
		//											(Java에 기본 내장된 인터페이스)
		// Java.sql 패키지에서 제공
		...
		//    JDBC를 상속 받아 구현한 클래스 모음(ojbdc11.jar 라이브러리)
		//		--> OracleDriver.class (JDBC 드라이버) 이용
		
		// 1단계 : JDVC 객체 참조 변수 선언 (java.sql 패키지의 인터페이스)
		...
		try {
			...
			String ip = "localhost";// DB 서버 컴퓨터IP
									// localhost == 127.0.0.1 (loop back ip)
									// 115.90.212.22
			String port = ":49679"; //포트번호
									// 9000 (학원서버컴)
			String sid = ":XE"; // DB 이름
			String user = "kh_khd";
			...
			// 3. SQL 작성
			// ** JAYA에서 작성되는 SQL은 마지막에 ;(세미콜론)을 찍지 않아야 한다.!! **
