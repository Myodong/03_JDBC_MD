...
-- 사용자 계정 생성
CREATE USER member_khd IDENTIFIED BY member1234;

-- 생성한 사용자 계정에 권한 부여
GRANT CONNECT, RESOURCE, CREATE VIEW TO member_khd;

-- 테이블 스페이스 할당 
ALTER USER member_khd DEFAULT
...
-- member_khd
-- 회원 테이블 
-- 회원 번호, 아이디, 이름, 비밀번호, 이름, 성별, 가입일, 탈퇴여부
CREATE  TABLE "MEMBER"(
