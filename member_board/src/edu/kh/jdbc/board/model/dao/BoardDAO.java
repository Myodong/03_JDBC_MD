...
public class BoardDAO {
	 ...
	 * @throws Exception
	 */
	public Board slsectBoard(Connection conn, int boardNo)throws Exception {
		// 결과 저장용 변수 선언
		Board board = null;
		
		try {
			// SQL 얻어오기
			String sql =prop.getProperty("slsectBoard");
			...
			if (rs.next()) { // 조회 결과가 있을 경우
				board = new Board(); // Board 객체 생성 == board는 null아님
