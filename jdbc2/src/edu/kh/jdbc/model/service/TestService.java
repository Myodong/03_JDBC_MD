...
//		Connection conn = JDBCTemplate.getConnection();
	...
	public int insert(TestVO vo1, TestVO vo2, TestVO vo3) throws Exception{
		...
		int res = 0; // insert 3회 모두 성공시 1, 아니며 0
		
		try {
			// insert 중 오류가 발생하면 모둥 insert내용 reollback
